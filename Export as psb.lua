...
package.manifest = {
    ...
    description = "Exports sprite as a PSB file",
    version = "v1.3.2",
...
local function getOptionsFromDialog ()
    ...
    dialog
        :file({
            ...
            title = "Save as...",
            save = true,
            filename = app.fs.filePathAndTitle(sprite.filename) .. ".psb",
            filetypes = { "psb" },
        })
        :combobox({
            id = "frame",
...
if not app.isUIAvailable then
    print("Export as psb: version " .. tostring(package.manifest.version))
end
...
if showCompleated then
    if app.isUIAvailable then
        app.alert({
            ...
            text = "PSB successfully exported to " .. filename,
            buttons = "OK",
        })
    else
        print("PSB successfully exported to " .. filename)
    end
end
